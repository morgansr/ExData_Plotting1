...
# top left
plot(hpc_ss$DateTime, hpc_ss$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")

# top right
plot(hpc_ss$DateTime, hpc_ss$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
# bottom right
plot(hpc_ss$DateTime, hpc_ss$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
